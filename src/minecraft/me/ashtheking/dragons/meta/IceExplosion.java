...
public class IceExplosion {
	...
	public IceExplosion(World par1World, Entity par2Entity, double par3, double par5, double par7,
			float par9) {
	...
	public void doExplosionB(boolean par1) {
		...
		for (int j = arraylist.size() - 1; j >= 0; j--) {
			...
			if ((j2 == 0 || j2 == Block.fire.blockID) && Block.opaqueCubeLookup[k2]
					&& explosionRNG.nextInt(3) == 0) {
				worldObj.setBlockWithNotify(l, j1, l1, 0);
				// worldObj.setBlockWithNotify(l, j1, l1, Block.Ice.blockID);
			}
