...
public class Fireball extends Entity
{
    ...
    public Fireball(World world, double d, double d1, double d2, 
    ...
    public Fireball(World world, EntityLiving entityliving, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public void onUpdate()
    {
        ...
        worldObj.spawnParticle("explosion", posX, posY, posZ, 0.0D, 0.0D, 0.0D);
        setPosition(posX, posY, posZ);
    }
