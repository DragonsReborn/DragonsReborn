...
public class StaffEntity extends Entity {
	...
	public StaffEntity(World world, EntityLiving entityliving, float f) {
		super(world);
		xTile = -1;
		yTile = -1;
		zTile = -1;
		...
		setLocationAndAngles(entityliving.posX,
				entityliving.posY + (double) entityliving.getEyeHeight(), entityliving.posZ,
	...
	public void onUpdate() {
		...
		if (movingobjectposition != null) {
			if (movingobjectposition.entityHit != null) {
				...
				float f2 = MathHelper.sqrt_double(motionX * motionX + motionY * motionY + motionZ
						* motionZ);
		...
		for (rotationPitch = (float) ((Math.atan2(motionY, f3) * 180D) / 3.1415927410125732D); rotationPitch
